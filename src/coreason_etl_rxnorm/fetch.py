...
class EpistemicRxNormFetchIntent(BaseModel):
    """
    AGENT INSTRUCTION: This class is responsible for fetching the latest RxNorm Full Monthly Release
    ...
    def execute(self) -> Path:
        """
        Executes the fetch intent, downloading the latest RxNorm release.
        ...
        logger.info("Fetching latest RxNorm Full Monthly Release URL.")
        release_url = "https://uts-ws.nlm.nih.gov/releases?releaseType=rxnorm-full-monthly-release&current=true"
        ...
        logger.info("Downloading RxNorm archive.")
        ...
        try:
            ...
            logger.exception("Failed to download RxNorm archive.")
