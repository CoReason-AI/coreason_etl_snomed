...
def test_epistemic_ontology_pipeline_intent_success(mock_policy: EpistemicOntologyPolicy) -> None:
    ...
    with (
        ...
        # Removed patch for mock_gold_synonym
        ...
        # Removed mock_gold_synonym.assert_called_once_with
        ...
        mock_gold_load.assert_called_once_with(
            ...
            fact_relationship=mock_gold_relationship_lf, # Removed bridge_synonym argument
        )
